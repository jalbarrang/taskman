import {
  filterInitiatives, loadInitiativeListItems, type InitiativeListItem, type StatusFilter as InitiativeFilter,
} from '../listing/initiatives.js';
import {
  filterPlans, loadPlanListItems, sortPlans, type PlanListItem, type SortField, type StatusFilter as PlanFilter,
...
export type PlanListResult = { kind: 'plans'; items: PlanListItem[]; filter: PlanFilter; sort: SortField };
export type InitiativeListResult = { kind: 'initiatives'; items: InitiativeListItem[]; filter: InitiativeFilter };
